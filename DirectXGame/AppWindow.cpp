...
void AppWindow::onUpdate()
{
	...
	GraphicsEngine::get()->getRenderSystem()->getImmediateDeviceContext()->drawIndexedTriangleList(m_ib->getSizeIndexList(), 0, 0); // STRIP RENDERING
...
void AppWindow::onMouseMove(const Point& mouse_pos)
{
	...
	m_rot_x += (mouse_pos.m_y - (height/2)) * m_delta_time;
